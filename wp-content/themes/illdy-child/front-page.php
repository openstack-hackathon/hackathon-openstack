...
<?php
	...
	$sections_order_eleventh_section = get_theme_mod( 'illdy_general_sections_order_eleventh_section', 11 );
	$sections_order_twelvth_section = get_theme_mod( 'illdy_general_sections_order_twelfth_section', 12 );
	...
	if( $sections_order_tenth_section ):
		illdy_sections_order( $sections_order_tenth_section );
	endif;

	if( $sections_order_eleventh_section ):
		illdy_sections_order( $sections_order_eleventh_section );
	endif;
	...
	/*if( $sections_order_fourteenth_section ):
		illdy_sections_order( $sections_order_fourteenth_section );
	endif;*/
endif;

...
class Illdy_Widget_Person extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $entry = ( !empty( $instance['entry'] ) ? $instance['entry'] : '' );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <textarea class="widefat" id="<?php echo $this->get_field_id( 'entry' ); ?>" name="<?php echo $this->get_field_name( 'entry' ); ?>" type="text"><?php echo esc_attr( $entry ); ?></textarea>
        </p>
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['entry'] = ( !empty( $new_instance['entry'] ) ) ? $new_instance['entry'] : '';

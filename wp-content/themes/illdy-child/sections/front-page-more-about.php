<?php
/**
 *	The template for displaying the more about us section in front page.
 *
 *	@package WordPress
 *	@subpackage illdy
 */
...
<?php if ( is_active_sidebar( 'front-page-more-about-sidebar' ) ) { ?>

<section id="more-about" class="front-page-section">
	<div class="container">
		<div class="row">
			<?php
			if( is_active_sidebar( 'front-page-more-about-sidebar' ) ):
				dynamic_sidebar( 'front-page-more-about-sidebar' );

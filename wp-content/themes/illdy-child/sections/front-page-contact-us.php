...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$contact_bar_slack_url = get_theme_mod( 'illdy_contact_bar_slack_url', esc_url( '#' ) );
	$contact_bar_github_url = get_theme_mod( 'illdy_contact_bar_github_url', esc_url( '#' ) );
	...
	$contact_bar_slack_url = get_theme_mod( 'illdy_contact_bar_slack_url' );
	$contact_bar_github_url = get_theme_mod( 'illdy_contact_bar_github_url' );

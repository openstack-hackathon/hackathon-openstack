...
if ( current_user_can( 'edit_theme_options' ) ) {
	...
	$button_url = get_theme_mod( 'illdy_latest_news_button_url' );
	$number_of_posts = get_theme_mod( 'illdy_latest_news_number_of_posts', absint( 3 ) );
}
					...
					<?php while( $post_query->have_posts() ): ?>
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="post" style="<?php if( !$post_thumbnail ): echo 'padding-top: 40px;'; endif; ?>">
								...
								<a href="<?php the_permalink(); ?>" title="<?php _e( 'Leer más', 'illdy' ); ?>" class="post-button"><i class="fa fa-chevron-circle-right"></i><?php _e( 'Leer más', 'illdy' ); ?></a>
							</div><!--/.post-->
						</div><!--/.col-sm-4-->
					<?php endwhile; ?>
				</div><!--/.row-->

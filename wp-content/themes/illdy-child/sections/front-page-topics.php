<?php
/**
 *	The template for displaying the topics section in front page.
 *
 *	@package WordPress
 *	@subpackage illdy
 */
...
<?php if ( is_active_sidebar( 'front-page-topics-sidebar' ) ) { ?>

<section id="topics" class="front-page-section">
	<div class="container">
		<div class="row">
			<?php
			if( is_active_sidebar( 'front-page-topics-sidebar' ) ):
				dynamic_sidebar( 'front-page-topics-sidebar' );

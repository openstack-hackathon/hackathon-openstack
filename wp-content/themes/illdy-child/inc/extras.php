...
if( !function_exists( 'illdy_sections_order' ) ) {
    function illdy_sections_order( $input ) {
        ...
        $join_us_general_show = get_theme_mod( 'illdy_join_us_general_show', 1 );
        $schedule_general_show = get_theme_mod( 'illdy_schedule_general_show', 1 );
        $topics_general_show = get_theme_mod( 'illdy_topics_general_show', 1 );
        $banner_general_show = get_theme_mod( 'illdy_banner_general_show', 1 );
        $more_about_general_show = get_theme_mod( 'illdy_more_about_general_show', 1 );
        $sponsors_general_show = get_theme_mod( 'illdy_sponsors_general_show', 1 );
        ...
        } elseif( $input == 9 && $join_us_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'join-us' );
        }elseif( $input == 10 && $schedule_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'schedule' );
        } elseif( $input == 11 && $topics_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'topics' );
        } elseif( $input == 12 && $banner_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'banner' );
        } elseif( $input == 13 && $more_about_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'more-about' );
        } elseif( $input == 14 && $sponsors_general_show == 1 ) {
            get_template_part( 'sections/front-page', 'sponsors' );
        }
    }
}

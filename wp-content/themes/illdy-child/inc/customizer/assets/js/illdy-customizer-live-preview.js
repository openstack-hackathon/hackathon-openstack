...
( function( $ ) {
	...
	/* Youtube URL */
	wp.customize( 'illdy_contact_bar_youtube_url', function( value ) {
		value.bind( function( newval ) {
			$( '#contact-us .section-content .contact-us-social a[title="Youtube"]' ).attr( 'href', newval );
		} );
	} );

	/* Slack URL */
	wp.customize( 'illdy_contact_bar_slack_url', function( value ) {
		value.bind( function( newval ) {
			$( '#contact-us .section-content .contact-us-social a[title="Slack"]' ).attr( 'href', newval );
		} );
	} );

	/* Github URL */
	wp.customize( 'illdy_contact_bar_github_url', function( value ) {
		value.bind( function( newval ) {
			$( '#contact-us .section-content .contact-us-social a[title="Github"]' ).attr( 'href', newval );
		} );
	} );
	...
	// Show this section
	wp.customize( 'illdy_join_us_general_show', function( value ) {
		value.bind( function( newval ) {
			if( newval == false ) {
				$( '#join-us' ).addClass( 'customizer-display-none' );
			} else if( newval == true ) {
				$( '#join-us' ).removeClass( 'customizer-display-none' );
			}
		} );
	} );

	// Type of Background
	wp.customize( 'illdy_join_us_background_type', function( value ) {
		value.bind( function( newval ) {
			if( newval == 'image' ) {
				$( '#join-us' ).css( 'background-color', '' );
				$( '#join-us' ).css( 'background-image', 'url('+ wp.customize._value.illdy_counter_background_image() +')' );
			} else if( newval == 'color' ) {
				$( '#join-us' ).css( 'background-image', '' );
				$( '#join-us' ).css( 'background-color', 'color:' + wp.customize._value.illdy_counter_background_color() );
			}
		} );
	} );

	// Image
	wp.customize( 'illdy_join_us_background_image', function( value ) {
		value.bind( function( newval ) {
			if( newval == '' ) {
				$( '#join-us' ).removeAttr( 'style' );
			} else {
				$( '#join-us' ).css( 'background-image', 'url('+ newval +')' );
			}
		} );
	} );

	// Color
	wp.customize( 'illdy_join_us_background_color', function( value ) {
		value.bind( function( newval ) {
			$( '#join-us' ).css( 'background-color', newval );
		} );
	} );

...
if(!function_exists('illdy_customize_register')) {
    function illdy_customize_register( $wp_customize ) {
        ...
        // Custom Controls
        require_once get_stylesheet_directory() . '/inc/customizer/custom-controls.php';

        // General Options
        require_once get_stylesheet_directory() . '/inc/customizer/panels/general-options.php';

        // Single Post Option
        require_once get_stylesheet_directory() . '/inc/customizer/panels/single-post-options.php';
        ...
        // Join Us
        require_once get_stylesheet_directory() . '/inc/customizer/panels/join-us.php';

        // Banner
        require_once get_stylesheet_directory() . '/inc/customizer/panels/banner.php';

        // More About Us
        require_once get_stylesheet_directory() . '/inc/customizer/panels/more-about.php';

        // Sponsors
        require_once get_stylesheet_directory() . '/inc/customizer/panels/sponsors.php';

        // Topics
        require_once get_stylesheet_directory() . '/inc/customizer/panels/topics.php';
    }

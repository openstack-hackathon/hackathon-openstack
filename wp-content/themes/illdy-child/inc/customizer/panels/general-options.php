<?php
    ...
    /* Slack URL */
    $wp_customize->add_setting( $prefix.'_contact_bar_slack_url',
        array(
            'sanitize_callback'  => 'esc_url',
            'default'            => esc_html('#'),
            'transport'          => 'postMessage'
    ...
    $wp_customize->add_control( $prefix.'_contact_bar_slack_url',
        array(
            'label'          => __( 'Slack URL', 'illdy' ),
            'description'    => __('Will be displayed in the contact section from front page.', 'illdy'),
            'section'        => $prefix.'_general_contact_section',
            'settings'       => $prefix.'_contact_bar_slack_url',
            'priority'       => 10
        )
    );

    /* GitHub URL */
    $wp_customize->add_setting( $prefix.'_contact_bar_github_url',
        array(
            'sanitize_callback'  => 'esc_url',
            'default'            => esc_html('#'),
            'transport'          => 'postMessage'
    ...
    $wp_customize->add_control( $prefix.'_contact_bar_github_url',
        array(
            'label'          => __( 'GitHub URL', 'illdy' ),
            'description'    => __('Will be displayed in the contact section from front page.', 'illdy'),
            'section'        => $prefix.'_general_contact_section',
            'settings'       => $prefix.'_contact_bar_github_url',
            'priority'       => 10
        )
    );

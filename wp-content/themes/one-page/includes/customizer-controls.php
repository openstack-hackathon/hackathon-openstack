...
// Begin the output.
    ...
    /**
     * Onepage upgrade control 
     */
    class Onepage_Upgrade_control extends WP_Customize_Control {

        /**
         * Control Type
         */
        public $type = 'upgrade_msg';
        ...
        public function render_content() {
            ...
            <label>
                ...
                // Output the label and description if they were passed in.
                if (isset($this->label) && '' !== $this->label) {
                    echo '<span class="customize-control-title lock-tab">' . sanitize_text_field($this->label) . '</span>';
                }
                if (isset($this->description) && '' !== $this->description) {
                    echo '<span class="description customize-control-description upgrade">' . wp_kses_post($this->description) . '</span>';
                }
                ?>
            </label>
            <?php
    ...
    class Onepage_Upgrade_control2 extends WP_Customize_Control {

        /**
         * Control Type
         */
        public $type = 'upgrade_msg2';

...
<!-- pricing Section -->
<section id="jueces" class="section_7">
        <div class="container">
          <h2 class="title txt-center">Jueces</h2>
          ...
          <div class="col-xs-3">
              <div class="juez" id="ruy-cervantes-photo">
                ...
                <h4><span>Ruy </span> Cervantes</h4>
              </div>
            </div>



            <div class="col-xs-3" id="mak-gutierrez-photo">
              <div class="juez" >
                <div class="unhover_img">
                    <img src="openstack/img/jueces/mark-gutirrez.jpeg" alt="Mak Gutierrez" />
                </div>
                <h4><span>Mak </span> Gutiérrez</h4>
              </div>
            </div>
